...
public class Logger {
    ...
    public static void broadCast(String message) {
        BlockStreet.INSTANCE.getServer().broadcastMessage(String.format("%s[%s%s%s]%s %s", ChatColor.GRAY, ChatColor.GOLD, "BlockStreet", ChatColor.GRAY, ChatColor.WHITE, message));
    }

    public static void broadCast(ChatColor chatColor, String message) {
        BlockStreet.INSTANCE.getServer().broadcastMessage(String.format("%s[%s%s%s]%s %s", ChatColor.GRAY, ChatColor.GOLD, "BlockStreet", ChatColor.GRAY, chatColor, message));
    }
